...
class ViewController: UIViewController, UIContextMenuInteractionDelegate {
    ...
    @objc func tappedSquare(_ sender: AnyObject)  {
        print("tapped")
    }
    
    
    private lazy var tbnContextMenu: UILabel = {
        let label = UILabel()
    ...
    private lazy var statStackView: UIStackView = {
       let stackView = UIStackView(arrangedSubviews: [humidityStackView, windStackView])
        ...
        stackView.translatesAutoresizingMaskIntoConstraints = false
        stackView.spacing = 3
        stackView.backgroundColor = UIColor.softGrayy
    ...
    override func viewDidLoad() {
        ...
        tbnContextMenu.addInteraction(menuInteraction)
    }
    ...
    private func setHierarchy() {
        ...
        view.addSubview(tbnContextMenu)
    ...
    private func setConstraint() {
        ...
        NSLayoutConstraint.activate([
            tbnContextMenu.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 23),
            tbnContextMenu.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            tbnContextMenu.leadingAnchor.constraint(equalTo: view.leadingAnchor)
            
        ])
        
        NSLayoutConstraint.activate([
            headerView.topAnchor.constraint(equalTo: tbnContextMenu.bottomAnchor, constant: 60),
        ...
        NSLayoutConstraint.activate([
            statStackView.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: 24),
            statStackView.widthAnchor.constraint(equalToConstant: 206),
            statStackView.centerXAnchor.constraint(equalTo: view.centerXAnchor)
        ])
        
        NSLayoutConstraint.activate([
            hourlyForecastLabel.topAnchor.constraint(equalTo: statStackView.bottomAnchor, constant: 29),
